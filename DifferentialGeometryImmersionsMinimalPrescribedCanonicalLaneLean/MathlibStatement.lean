...
def mathlibProofObligation : MathlibProofObligation := {
  sourceKey := "differential-geometry-immersions-minimal-prescribed",
  theoremObject := "Existence of minimal immersion with prescribed curvature",
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedImmersionClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_immersion_endgame A
